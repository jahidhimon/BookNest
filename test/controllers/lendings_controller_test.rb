...
class LendingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lending" do
    assert_difference("Lending.count") do
      post lendings_url, params: { lending: { book_id: @lending.book_id, penalty: @lending.penalty, return_date: @lending.return_date, returned_date: @lending.returned_date, user_id: @lending.user_id } }
    end
  ...
  test "should update lending" do
    patch lending_url(@lending), params: { lending: { book_id: @lending.book_id, penalty: @lending.penalty, return_date: @lending.return_date, returned_date: @lending.returned_date, user_id: @lending.user_id } }
